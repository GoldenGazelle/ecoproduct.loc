      ...
      <div id="body-top">
        ...
        <div id="gboxm">            
				...
				else
				{
					...
					<center><a href="edit_pointf.php?id=0"><img height="37" src="images/add.png" alt="add" />Добавить</a>										
					...
					{?>
						<tr>
						<td><a href="edit_pointf.php?id=<?=$item["id"]?>"><img src="images/edit.ICO" alt="edit" /></a></td>						
						<td><?=$item["point"]?></td>					
						<td><?=$item["region"]?></td>
						<td><a href="delete_point.php?id=<?=$item["id"]?>"><img src="images/del.ICO" alt="del" /></a></td>
						</tr>
					<?}
						echo "</table>";				
					}?>	         
