      ...
      <div id="body-top">
        ...
        <div id="gboxm">            
				...
				else
				{
					...
					<center><a href="edit_pointf.php?id=0"><img height="37" src="images/logos/add.png" alt="add" />Добавить</a>
					<h2>Города приемки и отправки</center></h2>
					...
					{?>
						<tr>
						<td><a href="edit_pointf.php?id=<?=$item["id"]?>"><img src="images/logos/edit.ico" alt="edit" /></a></td>
						<td><?=$item["point"]?></td>					
						<td><?=$item["region"]?></td>
						<td><a href="delete_point.php?id=<?=$item["id"]?>"><img src="images/logos/del.ICO" alt="del" /></a></td>
						</tr>
					<?}
						echo "</table>";				
					}?>	         
