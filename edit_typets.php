      ...
      <div id="body-top">
        ...
        <div id="gboxm">              
				...
				else
				{
					...
					<center><a href="edit_typetsf.php?id=0"><img height="37" src="images/add.png" alt="add" />Добавить</a>										
					...
					{?>
						<tr>
						<td><a href="edit_typetsf.php?id=<?=$item["id"]?>"><img src="images/edit.ICO" alt="edit" /></a></td>						
						<td><?=$item["type"]?></td>					
						<td><?=number_format($item["price"], 2)?></td>
						<td><a href="delete_typets.php?id=<?=$item["id"]?>"><img src="images/del.ICO" alt="del" /></a></td>
						</tr>
					<?}
						echo "</table>";				
					}?>				  
